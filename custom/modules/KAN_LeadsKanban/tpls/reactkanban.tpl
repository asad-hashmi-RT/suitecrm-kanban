{*
  Smarty template that hosts the React Kanban app.
  Same-origin hosting preserves SuiteCRM session cookies for API calls.
*}
{literal}
<style>
  .kanban-host #root {
...
{else}
  <div class="alert alert-warning" style="margin-top: 12px;">
    React build assets not found. Place the production build in:
