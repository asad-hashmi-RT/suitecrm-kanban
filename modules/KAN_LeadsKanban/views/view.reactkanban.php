<?php
/**
 * Full-page host view for React Kanban.
 *
 * Uses assets from custom/modules/KAN_LeadsKanban/client/dist.
 */
...
class KAN_LeadsKanbanViewReactkanban extends SugarView
{
    public function display()
    {
        ...
        $this->ss->display('modules/KAN_LeadsKanban/tpls/reactkanban.tpl');
    }
